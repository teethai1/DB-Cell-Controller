...
Public Class S12F4CanonDownload
    ...
    Public Sub SetS12F4Canon(ByVal MID As String, ByVal IDTYP As Byte, ByVal FNLOC As UShort, ByVal ORLOC As Byte, ByVal REEP As List(Of Point), ByVal ROWCT As UShort, ByVal COLCT As UShort, ByVal PRDCT As UInteger, ByVal BCEQU As String, ByVal NULBC As String)
        ...
        Dim m_RPSEL As New SecsItemU1("RPSEL", 1)
        Dim m_Ln As New SecsItemList("LnREFP")
        Dim m_Refp As SecsItemI4
        ...
        Dim m_MLCL As New SecsItemU2("MLCL", 0)

        m_Refp = New SecsItemI4("Reep")
        For i = 0 To REEP.Count - 1
            m_Ln.AddItem(New SecsItemI4("Reep", {CShort(REEP(i).X), CShort(REEP(i).Y)}))
        Next
